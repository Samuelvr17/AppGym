            ...
            <div key={exercise.id} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-4">
              ...
              <div className="space-y-3 mb-4">
                {exercise.sets.map((set, setIndex) => (
                  <div key={setIndex} className="flex flex-wrap items-center gap-1.5 xs:gap-2 sm:gap-3">
                    <span className="text-sm font-medium text-gray-600 dark:text-gray-400 w-6 xs:w-7 text-center sm:text-left sm:w-8">
                      {setIndex + 1}
                    </span>
                    <div className="flex items-center space-x-1 xs:space-x-2">
                      <input
                        ...
                        className="w-14 xs:w-16 sm:w-18 px-2 xs:px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-center focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                        placeholder="0"
                      />
                    ...
                    <div className={`flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-2 sm:ml-auto ${isResting && activeRest?.exerciseId === exercise.id && activeRest.setIndex === setIndex ? 'w-full items-center justify-center sm:w-auto' : ''}`}>
                      {isResting && activeRest?.exerciseId === exercise.id && activeRest.setIndex === setIndex ? (
                        <div className="flex items-center justify-between bg-green-50 dark:bg-green-900/20 rounded-lg px-1.5 xs:px-2 py-1.5 border border-green-100 dark:border-green-800/50 shadow-sm w-auto min-w-[150px] xs:min-w-[170px] sm:min-w-[180px]">
                          <button
                            onClick={() => adjustRestTime(-30)}
                            className="text-[10px] xs:text-xs font-medium text-green-700 dark:text-green-300 hover:bg-green-200 dark:hover:bg-green-800 rounded px-1.5 xs:px-2 py-1 transition-colors"
                          >
                            -30s
                          </button>
                          <span className="font-mono font-bold text-green-700 dark:text-green-400 text-xs xs:text-sm mx-0.5 xs:mx-1">
                          ...
                          <div className="w-px h-4 bg-green-200 dark:bg-green-700 mx-1 xs:mx-2"></div>
                          <button
                            onClick={cancelRestTimer}
                            className="text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded p-0.5 xs:p-1 transition-colors"
                            title="Detener"
                          >
                        ...
                        <button
                          ...
                          className="text-xs bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 px-2 xs:px-3 py-1 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 w-full sm:w-auto"
                        >
                          Desc.
                        </button>
                      )}
